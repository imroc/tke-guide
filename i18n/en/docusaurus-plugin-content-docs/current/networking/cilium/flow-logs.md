...
TKE uses the LogConfig CRD to configure log collection rules. This approach allows quick index configuration without extensive manual operations in the console. The complete LogConfig configuration is as follows:
