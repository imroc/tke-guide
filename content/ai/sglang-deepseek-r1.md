...
正式购买阶段，需通过 [高性能计算平台-工作空间](https://console.cloud.tencent.com/thpc/workspace/index) 购买，不支持按量计费，其规格、机型、核心参数和正式购买入口的对照表如下：

| 规格              | 机型                 | RDMA          | CPU核心数 | 内存(GB) | GPU 卡数 | 购买入口                                   |
| ----------------- | -------------------- | ------------- | --------- | -------- | -------- | ------------------------------------------ |
| 96AS.32XLARGE1280 | PNV6.32XLARGE1280    | 不支持        | 128       | 1280     | 8        | 高性能计算平台-工作空间-新建，选择标准空间 |
| 96AS.32XLARGE1280 | PNV6.96XLARGE2304    | 不支持        | 384       | 2304     | 8        | 高性能计算平台-工作空间-新建，选择标准空间 |
| 96A.96XLARGE2304  | HCCPNV6.96XLARGE2304 | 支持(3.2Tbps) | 384       | 2304     | 8        | 高性能计算平台-工作空间-新建，选择互联空间 |
