...
skopeo copy -a docker://quay.io/cilium/cilium:v1.19.1  docker://your-tcr-name.tencentcloudcr.com/quay.io/cilium/cilium:v1.19.1
skopeo copy -a docker://quay.io/cilium/operator-generic:v1.19.1  docker://your-tcr-name.tencentcloudcr.com/quay.io/cilium/operator-generic:v1.19.1
```
...
source_images=$(helm template cilium cilium/cilium --version 1.19.1 \
  --namespace kube-system \
  --set operator.tolerations[0].key="node-role.kubernetes.io/control-plane",operator.tolerations[0].operator="Exists" \
  --set operator.tolerations[1].key="node-role.kubernetes.io/master",operator.tolerations[1].operator="Exists" \
  --set operator.tolerations[2].key="node.kubernetes.io/not-ready",operator.tolerations[2].operator="Exists" \
