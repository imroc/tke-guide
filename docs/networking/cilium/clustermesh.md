...
```bash
helm --kube-context=$CLUSTER1 upgrade --install cilium cilium/cilium --version 1.19.1 \
...
helm --kube-context=$CLUSTER2 upgrade --install cilium cilium/cilium --version 1.19.1 \
  --namespace kube-system \
