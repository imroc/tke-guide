...
```bash
helm --kube-context=$CLUSTER1 upgrade --install cilium cilium/cilium --version 1.18.5 \
...
helm --kube-context=$CLUSTER2 upgrade --install cilium cilium/cilium --version 1.18.5 \
  --namespace kube-system \
