...
```bash
helm --kube-context=$CLUSTER1 upgrade --install cilium cilium/cilium --version 1.19.3 \
...
helm --kube-context=$CLUSTER2 upgrade --install cilium cilium/cilium --version 1.19.3 \
  --namespace kube-system \
