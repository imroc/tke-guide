...
cilium 官方文档已将 "Layer 7 Policy" 列为 generic-veth chaining 模式的已知 Limitations，详见 [Cilium Docs - Generic Veth Chaining § Limitations](https://docs.cilium.io/en/stable/installation/cni-chaining-generic-veth/#limitations) 及跟踪 issue [cilium/cilium#12454](https://github.com/cilium/cilium/issues/12454)。
