...
再看 `kubernetes` 这个 Service 及其关联的 EndpointSlice 相关审计日志：

```txt
objectRef.namespace:"default" AND ((objectRef.name:"kubernetes" AND objectRef.resource:"services") OR (objectRef.name:"kubernetes" AND objectRef.resource:"endpointslices")) NOT verb:get
...
```bash
time=2026-01-04T12:28:48.711738343Z level=info msg="DEBUG: convertService" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector svc="&{Name:default/kubernetes-intranet Source:k8s Labels:k8s:service.cloud.tencent.com/loadbalance-type=INTERNAL Annotations:map[service.cloud.tencent.com/client-token:ed7a31f0-24cd-4aea-ab10-e00d63994dd8 service.cloud.tencent.com/direct-access:true service.cloud.tencent.com/loadbalancer-source-endpoints:{\"name\":\"kubernetes-intranet-loadbalancer\"} service.cloud.tencent.com/sync-begin-time:2026-01-04T20:28:47+08:00 service.cloud.tencent.com/sync-end-time:2026-01-04T20:28:48+08:00 service.kubernetes.io/loadbalance-id:lb-ly81db73 service.kubernetes.io/qcloud-loadbalancer-internal-subnetid:subnet-loelppdt] Selector:map[] NatPolicy: ExtTrafficPolicy:Cluster IntTrafficPolicy:Cluster ForwardingMode: SessionAffinity:false SessionAffinityTimeout:0s LoadBalancerClass:<nil> ProxyRedirect: HealthCheckNodePort:0 LoopbackHostPort:false SourceRanges:[] PortNames:map[https:443] TrafficDistribution:}" fes="[{Address:192.168.60.179:443/TCP Type:ClusterIP ServiceName:default/kubernetes-intranet PortName:https ServicePort:443} {Address:0.0.0.0:30965/TCP Type:NodePort ServiceName:default/kubernetes-intranet PortName:https ServicePort:443} {Address:10.15.1.8:443/TCP Type:LoadBalancer ServiceName:default/kubernetes-intranet PortName:https ServicePort:443}]"
time=2026-01-04T12:28:48.711881231Z level=info msg="DEBUG: fe before UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:0.0.0.0:30965/TCP Type:NodePort ServiceName:default/kubernetes-intranet PortName:https ServicePort:443} Status:Done (45.5s ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:12 RedirectTo:<nil> Service:0xc0018d5500}" found=true backends="[{\"Address\":\"169.254.128.7:60002/TCP\",\"PortNames\":[\"https\"],\"Weight\":100,\"NodeName\":\"\",\"Zone\":\"\",\"ForZones\":null,\"ClusterID\":0,\"Source\":\"k8s\",\"State\":0,\"Unhealthy\":false,\"UnhealthyUpdatedAt\":\"0001-01-01T00:00:00Z\"}]"
time=2026-01-04T12:28:48.711958507Z level=info msg="DEBUG: fe before UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:10.15.1.8:443/TCP Type:LoadBalancer ServiceName:default/kubernetes-intranet PortName:https ServicePort:443} Status:Done (45.5s ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:14 RedirectTo:<nil> Service:0xc0018d5500}" found=true backends="[{\"Address\":\"169.254.128.7:60002/TCP\",\"PortNames\":[\"https\"],\"Weight\":100,\"NodeName\":\"\",\"Zone\":\"\",\"ForZones\":null,\"ClusterID\":0,\"Source\":\"k8s\",\"State\":0,\"Unhealthy\":false,\"UnhealthyUpdatedAt\":\"0001-01-01T00:00:00Z\"}]"
time=2026-01-04T12:28:48.712005144Z level=info msg="DEBUG: fe before UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:192.168.60.179:443/TCP Type:ClusterIP ServiceName:default/kubernetes-intranet PortName:https ServicePort:443} Status:Done (45.5s ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:15 RedirectTo:<nil> Service:0xc0018d5500}" found=true backends="[{\"Address\":\"169.254.128.7:60002/TCP\",\"PortNames\":[\"https\"],\"Weight\":100,\"NodeName\":\"\",\"Zone\":\"\",\"ForZones\":null,\"ClusterID\":0,\"Source\":\"k8s\",\"State\":0,\"Unhealthy\":false,\"UnhealthyUpdatedAt\":\"0001-01-01T00:00:00Z\"}]"
time=2026-01-04T12:28:48.712100182Z level=info msg="DEBUG: fe after UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:0.0.0.0:30965/TCP Type:NodePort ServiceName:default/kubernetes-intranet PortName:https ServicePort:443} Status:Pending (66.7us ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:12 RedirectTo:<nil> Service:0xc001113180}" found=true backends="[{\"Address\":\"169.254.128.7:60002/TCP\",\"PortNames\":[\"https\"],\"Weight\":100,\"NodeName\":\"\",\"Zone\":\"\",\"ForZones\":null,\"ClusterID\":0,\"Source\":\"k8s\",\"State\":0,\"Unhealthy\":false,\"UnhealthyUpdatedAt\":\"0001-01-01T00:00:00Z\"}]"
time=2026-01-04T12:28:48.712142752Z level=info msg="DEBUG: fe after UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:10.15.1.8:443/TCP Type:LoadBalancer ServiceName:default/kubernetes-intranet PortName:https ServicePort:443} Status:Pending (81.7us ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:14 RedirectTo:<nil> Service:0xc001113180}" found=true backends="[{\"Address\":\"169.254.128.7:60002/TCP\",\"PortNames\":[\"https\"],\"Weight\":100,\"NodeName\":\"\",\"Zone\":\"\",\"ForZones\":null,\"ClusterID\":0,\"Source\":\"k8s\",\"State\":0,\"Unhealthy\":false,\"UnhealthyUpdatedAt\":\"0001-01-01T00:00:00Z\"}]"
time=2026-01-04T12:28:48.712175374Z level=info msg="DEBUG: fe after UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:192.168.60.179:443/TCP Type:ClusterIP ServiceName:default/kubernetes-intranet PortName:https ServicePort:443} Status:Pending (106.3us ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:15 RedirectTo:<nil> Service:0xc001113180}" found=true backends="[{\"Address\":\"169.254.128.7:60002/TCP\",\"PortNames\":[\"https\"],\"Weight\":100,\"NodeName\":\"\",\"Zone\":\"\",\"ForZones\":null,\"ClusterID\":0,\"Source\":\"k8s\",\"State\":0,\"Unhealthy\":false,\"UnhealthyUpdatedAt\":\"0001-01-01T00:00:00Z\"}]"
time=2026-01-04T12:28:50.711978131Z level=info msg="DEBUG: convertService" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector svc="&{Name:default/kubernetes Source:k8s Labels:k8s:component=apiserver,k8s:provider=kubernetes,k8s:service.cloud.tencent.com/loadbalance-type=OPEN Annotations:map[service.cloud.tencent.com/client-token:cf84b188-b982-4186-9230-25adf2493404 service.cloud.tencent.com/sync-begin-time:2026-01-04T20:28:50+08:00 service.cloud.tencent.com/sync-end-time:2026-01-04T20:28:50+08:00 service.kubernetes.io/loadbalance-id:lb-qjyknmqt] Selector:map[] NatPolicy: ExtTrafficPolicy:Cluster IntTrafficPolicy:Cluster ForwardingMode: SessionAffinity:false SessionAffinityTimeout:0s LoadBalancerClass:<nil> ProxyRedirect: HealthCheckNodePort:0 LoopbackHostPort:false SourceRanges:[] PortNames:map[https:443] TrafficDistribution:}" fes="[{Address:192.168.0.1:443/TCP Type:ClusterIP ServiceName:default/kubernetes PortName:https ServicePort:443} {Address:0.0.0.0:30724/TCP Type:NodePort ServiceName:default/kubernetes PortName:https ServicePort:443} {Address:139.155.65.129:443/TCP Type:LoadBalancer ServiceName:default/kubernetes PortName:https ServicePort:443}]"
time=2026-01-04T12:28:50.712103686Z level=info msg="DEBUG: fe before UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:0.0.0.0:30724/TCP Type:NodePort ServiceName:default/kubernetes PortName:https ServicePort:443} Status:Done (499.9ms ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:8 RedirectTo:<nil> Service:0xc000001ea0}" found=true backends=null
time=2026-01-04T12:28:50.712152548Z level=info msg="DEBUG: fe before UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:139.155.65.129:443/TCP Type:LoadBalancer ServiceName:default/kubernetes PortName:https ServicePort:443} Status:Done (500.0ms ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:10 RedirectTo:<nil> Service:0xc000001ea0}" found=true backends=null
time=2026-01-04T12:28:50.712183777Z level=info msg="DEBUG: fe before UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:192.168.0.1:443/TCP Type:ClusterIP ServiceName:default/kubernetes PortName:https ServicePort:443} Status:Done (500.0ms ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:11 RedirectTo:<nil> Service:0xc000001ea0}" found=true backends=null
time=2026-01-04T12:28:50.712597434Z level=info msg="DEBUG: fe after UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:0.0.0.0:30724/TCP Type:NodePort ServiceName:default/kubernetes PortName:https ServicePort:443} Status:Pending (397.7us ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:8 RedirectTo:<nil> Service:0xc0011136c0}" found=true backends=null
time=2026-01-04T12:28:50.712670802Z level=info msg="DEBUG: fe after UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:139.155.65.129:443/TCP Type:LoadBalancer ServiceName:default/kubernetes PortName:https ServicePort:443} Status:Pending (450.3us ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:10 RedirectTo:<nil> Service:0xc0011136c0}" found=true backends=null
time=2026-01-04T12:28:50.712717711Z level=info msg="DEBUG: fe after UpsertServiceAndFrontends" module=agent.controlplane.loadbalancer-reflectors.k8s-reflector fe="&{FrontendParams:{Address:192.168.0.1:443/TCP Type:ClusterIP ServiceName:default/kubernetes PortName:https ServicePort:443} Status:Pending (161.2us ago) Backends:0x28f3b80 HealthCheckBackends:0x28f3b80 ID:11 RedirectTo:<nil> Service:0xc0011136c0}" found=true backends=null
```
